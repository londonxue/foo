...
- (NSArray  *)findAllWithWhereCondition:(NSString *)condition conditionParams:(NSDictionary *)conditionParams isDistinct:(BOOL)isDistinct error:(NSError **)error
{
    CTPersistanceCriteria *criteria = [[CTPersistanceCriteria alloc] init];
...
- (NSArray *)findAllWithSQL:(NSString *)sqlString params:(NSDictionary *)params error:(NSError **)error
{
    if (sqlString == nil) {
        return [NSArray new];
    }
...
- (NSArray  *)findAllWithCriteria:(CTPersistanceCriteria *)criteria error:(NSError **)error
{
...
- (NSArray *)findAllWithPrimaryKey:(NSArray  *)primaryKeyValueList error:(NSError **)error
{
